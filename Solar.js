...
var near = 15;      // near clipping plane's distance
...
function render() {
  ...
  //mercury
  //copy and paste from sun and change variables
  //name;planet;data
  name = "Mercury";
  planet = Planets[name];
  data = SolarSystem[name];
  ...
  ms.push();
  //rotate at one day year * 365
  ms.rotate((time * data.year * 365), [0,1,0]);
  ms.translate(((data.distance * 500) + 3), 0, 0);
  ms.scale(data.radius/1);
  ...
  ms.translate(((data.distance * 2) ), 0, 0);
